...
δ-δ r q γ β • δ-δ t s α ζ =[UIP]=
δ-δ t s α ζ • δ-δ r q γ β

δ t α ∘ δ s+1 ζ ∘ δ r γ ∘ δ q+1 β =[δ-δ r q γ β]=
δ t α ∘ δ s+1 ζ ∘ δ q β ∘ δ r γ   =[δ-δ t s α ζ]=
δ s ζ ∘ δ t α   ∘ δ q β ∘ δ r γ

δ t α ∘ δ s+1 ζ ∘ δ r γ ∘ δ q+1 β =[δ-δ t s α ζ]=
δ s ζ ∘ δ t α   ∘ δ r γ ∘ δ q+1 β =[δ-δ r q γ β]=
δ s ζ ∘ δ t α   ∘ δ q β ∘ δ r γ
```
