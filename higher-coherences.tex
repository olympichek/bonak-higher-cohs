...
\centerslidediagram{
  \fitdiagram{\SquareTermCohDiagram
    {\termfour{\del{t}{\alpha}}{\del{s+1}{\zeta}}{\del{r+2}{\gamma}}{\del{q+3}{\beta}}}
    {\termfour{\del{t}{\alpha}}{\del{s+1}{\zeta}}{\del{q+2}{\beta}}{\del{r+2}{\gamma}}}
    {\termfour{\del{s}{\zeta}}{\del{t}{\alpha}}{\del{r+2}{\gamma}}{\del{q+3}{\beta}}}
    {\termfour{\del{s}{\zeta}}{\del{t}{\alpha}}{\del{q+2}{\beta}}{\del{r+2}{\gamma}}}
    {\HCdd{r+2}{q+2}{\gamma}{\beta}}
    {\HCdd{t}{s}{\alpha}{\zeta}}
    {\HCdd{t}{s}{\alpha}{\zeta}}
    {\HCdd{r+2}{q+2}{\gamma}{\beta}}}
}
